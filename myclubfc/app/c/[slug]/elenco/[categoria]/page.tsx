    ...
    <div className="mx-auto max-w-4xl px-4 md:px-0">
      ...
      <div className="grid grid-cols-2 gap-3 pb-6 sm:grid-cols-3 md:grid-cols-4">
        {jogadores.length === 0 ? (
          ...
          jogadores.map((j) => (
            <Link key={j.id} href={`${base}/jogador/${j.id}`}>
...
// generateStaticParams removido: categorias agora dependem do tenant atual e
// são resolvidas dinamicamente em runtime via getCurrentClub()
